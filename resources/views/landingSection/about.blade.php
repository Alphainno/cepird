...
<section id="about" class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Accelerating a Knowledge-Driven Economy</h2>
            <div class="w-20 h-1 bg-teal-500 mx-auto rounded-full"></div>
            <p class="mt-4 text-slate-600 max-w-2xl mx-auto">
                CEPIRD serves as the premier think-tank and execution hub for modernizing the entrepreneurial landscape.
            </p>
        </div>
