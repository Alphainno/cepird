            ...
            <div class="flex flex-col md:flex-row">
                <div class="md:w-2/5 bg-slate-100 relative min-h-[300px]">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-slate-200">
                        ...
                        <img src="/images/shahariar.png" alt="Mohammad Shahriar Khan" class="object-cover w-full h-full">
                        <span class="absolute bottom-4 text-xs text-slate-500">Photo: M. Shahriar Khan</span>
                    </div>
                </div>
                <div class="md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <h2 class="text-3xl font-bold text-slate-900 mb-2">Mohammad Shahriar Khan</h2>
                    <p class="text-teal-600 font-medium mb-6">Entrepreneur • Ecosystem Builder • Policy Advocate</p>

                    <blockquote class="text-slate-600 italic text-lg leading-relaxed mb-8 border-l-4 border-slate-200 pl-4">
                        "Innovation should not be a privilege; it should be accessible to every dreamer who wants to build a better Bangladesh."
                    </blockquote>

                    <div class="flex gap-4">
                        <a href="#" class="p-2 rounded-full bg-slate-100 hover:bg-blue-100 hover:text-blue-900 transition-colors">
                            <!-- Linkedin Icon SVG -->
