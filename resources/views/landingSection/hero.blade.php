...
<header id="home" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 mb-8">
            ...
            <span class="text-xs font-bold text-blue-900 uppercase tracking-wide">Driving Bangladesh's Future</span>
        </div>
        ...
        <p class="max-w-2xl mx-auto text-lg md:text-xl text-slate-600 mb-10 leading-relaxed">
            Driving entrepreneurial growth, policy innovation, and digital transformation.
            Bridging the gap between academic research and real-world economic impact.
        </p>

        <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="#" class="w-full sm:w-auto px-8 py-4 bg-blue-900 text-white font-semibold rounded-sm hover:bg-blue-800 transition-colors shadow-lg flex items-center justify-center gap-2">
                Explore Programs
                <!-- ArrowRight Icon SVG -->
            ...
            <a href="#" class="w-full sm:w-auto px-8 py-4 bg-white text-blue-900 border border-slate-200 font-semibold rounded-sm hover:bg-slate-50 transition-colors shadow-sm flex items-center justify-center gap-2">
        ...
        <p class="mt-8 text-sm text-slate-500 font-medium">
            Founded by <span class="text-slate-800 font-bold border-b-2 border-amber-400">Mohammad Shahriar Khan</span>
        </p>
    </div>
</header>
