<!-- ================= SIDEBAR ================= -->
<aside id="sidebar"
    class="fixed lg:fixed lg:left-0 lg:top-0 w-64 h-screen bg-primary-dark text-white shadow-xl shrink-0 overflow-y-auto scrollbar-hide">
    ...
    <nav class="mt-4 p-3 space-y-1 pb-6">
        ...
        <a href="{{ route('admin.dashboard') }}"
            class="sidebar-link flex items-center px-4 py-3 rounded-xl hover:bg-indigo-700/70 transition duration-150 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-700 shadow-md' : '' }}">
        ...
        <!-- Programs (submenu) -->
        <div>
            <button onclick="toggleMenu('programsMenu', this)"
                class="sidebar-link w-full flex items-center px-4 py-3 rounded-xl hover:bg-indigo-700/70 transition duration-150">
                <svg class="w-5 h-5 mr-3 text-indigo-200" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                <span class="flex-1 text-left">Programs</span>
                <svg class="w-4 h-4 submenu-arrow text-indigo-300" fill="none" stroke="currentColor"
                    stroke-width="2" viewBox="0 0 24 24">
                    <path d="M9 5l7 7-7 7" />
                </svg>
            ...
            <div id="programsMenu" class="submenu ml-4 space-y-1 text-sm pt-1">
                ...
                <a href="{{ route('admin.program-impact.index') }}" class="block pl-8 pr-4 py-2 rounded-lg text-indigo-200 hover:bg-indigo-700/50 transition">Impact Stats</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div id="researchMenu" class="submenu ml-4 space-y-1 text-sm pt-1">
                ...
                <a href="{{ route('admin.research-categories.index') }}" class="block pl-8 pr-4 py-2 rounded-lg text-indigo-200 hover:bg-indigo-700/50 transition">Research Categories</a>
